...
// nestedFunction can access the internal variable because the variable was defined in the same function as nestedFunction (in the same block scope).
...
// console.log('Callbacks Step 2 - add:', add(3, 4));
...
// console.log('Callbacks Step 2 - multiply:', multiply(3, 4));
...
//  console.log('Callbacks Step 2 - greeting', greeting('Monica', 'Salas')); 
